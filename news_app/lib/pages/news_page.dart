...
import 'package:news_app/model/categories.dart';
import 'package:news_app/model/sidebar.dart';
...
class _NewsPageState extends State<NewsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: SideBar(),
      appBar: AppBar(title: const Text('Haber'),),
      body: Column(
      ...
      return Expanded(child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Card(
              child: Column(
                children: [
                  Image.network(vm.viewModel.articles[index].urlToImage??'https://thumbs.dreamstime.com/b/no-image-available-icon-flat-vector-no-image-available-icon-flat-vector-illustration-132482953.jpg'),
                  ListTile(
